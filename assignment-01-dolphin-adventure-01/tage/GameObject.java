...
public class GameObject
{
	...
	private void initTransforms() // called by constructors
	...
	*/
    ...
    public Vector3f getForwardVector() {
		// 'v' is a utility vector for JOML calls
		// forward vector is the third column of the world rotation matrix (0, 1, 2)
		return new Vector3f(worldRotation.getColumn(2, v));
    }

    public Vector3f getLocationInWorld() {
		// 'v' is a utility vector for JOML calls
