 ...
 * @author Matthew M.
 */
public class MovePitchDownActionKeyboard extends AbstractInputAction {
    private MyGame game;
    private GameObject avatar; // the avatar is the "main character" in the game
    private Camera camera;
    private float movement_speed,
            movement_scale_factor = -0.0003f; // negative because we are pitching downward

    public MovePitchDownActionKeyboard(MyGame game) {
        this.game = game;
